...
public class CheckerReportController
    ...
    private void initRrfEvent() {
        ...
        if (generateRrfBtn != null) {
            ...
            generateRrfBtn.addEventListener(
                    Events.ON_CLICK,
                    event -> {
                        ...
                        try {
                            ...
                            if (xmlBytes == null) {
                                ...
                                Messagebox.show(
                                        "No returned cheques found for RRF generation.",
                                        "Information",
                                        Messagebox.OK,
    ...
    private void initApprovedEvent() {
        ...
        if (generateApprovedBtn != null) {
            ...
            generateApprovedBtn.addEventListener(
                    Events.ON_CLICK,
                    event -> {
                        ...
                        try {
                            ...
                            if (xmlBytes == null) {
                                ...
                                Messagebox.show(
                                        "No approved cheques found for report generation.",
                                        "Information",
                                        Messagebox.OK,
                                        Messagebox.EXCLAMATION);
