...
public class SessionServiceImpl implements SessionService {
	...
	public boolean startSession(Long userId) {
		...
		if (activeSession != null) {
			throw new IllegalStateException("An internal processing session is already active.");
		}
	...
	public boolean endSession(Long sessionId, Long userId) {
		...
		if (activeSession == null) {
			throw new IllegalStateException("No active internal processing session exists.");
		}

		if (!activeSession.getSessionId().equals(sessionId)) {
			throw new IllegalStateException("The session is not the active processing session.");
		}
