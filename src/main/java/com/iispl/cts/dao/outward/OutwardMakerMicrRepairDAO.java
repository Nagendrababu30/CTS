...
public class OutwardMakerMicrRepairDAO {
    ...
    public List<OutwardBatch> getMicrErrorBatches(long userId) {
        ...
        String sql =
                 ...
                 *
                 * Only the specific returned cheque whose
                 * checker reason is MICR-related is included.
                 */
                "       ( " +
                ...
                "               'SEND_BACK' " +
                "           AND UPPER(TRIM(cp.checker_reason_code)) " +
                "               IN ( " +
                "                   'MICR', " +
                "                   'MICR_CORRECTION', " +
                "                   'MICR_MISMATCH' " +
        ...
        try (
            ...
            System.out.println(
                    "Error loading MICR repair batches"
            );
